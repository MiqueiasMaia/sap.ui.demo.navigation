sap.ui.require([
  ...
  var sViewName = "sap.ui.demo.navigation.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of sap.ui.demo.navigation"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title sap.ui.demo.navigation"
            });
        }
      }
